...
def generate_better_characters(file):
    ...
    final_characters = []
    titles = ["Dr.", "Professor", "Mr.", "Mrs.", "Aunt", "Uncle", "Mr. and Mrs.", "Ms.", "Miss"]
...
#patterns = create_training_data("/Volumes/GoogleDrive/My Drive/DHStuff/tutorials_and_cheatsheets/Python for DH Videos/NER/data/hp_characters.json", "PERSON")
#generate_rules(patterns)
#print(patterns)

nlp = spacy.load("/Users/spicy.kev/Desktop/hp_ner")

ie_data = {}
with open ("/Volumes/GoogleDrive/My Drive/DHStuff/tutorials_and_cheatsheets/Python for DH Videos/NER/data/hp.txt", "r") as f:
    text = f.read()
...
save_data("test_data.json", ie_data)
